...
//       © 2013-2024 SoulTrekker • <Link to="/privacy" className="text-light text-decoration-none">Privacy Policy</Link> • <Link to="/terms" className="text-light text-decoration-none">Terms and Conditions</Link>
//     </div>
//   </div>
// </footer>
...
//   );
// }
// function ScheduleCard({ day, title, shortDesc, fullDesc, image }) {
