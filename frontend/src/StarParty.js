...
function StarParty() {
 ...
 const navLinkStyle = {
    ...
    <div className="container-fluid p-0">
      ...
      <Container className="my-5">
        <h3 style={{ color: 'orange' }}>
          <i>StarParty - Lyrid Meteor Shower</i>
        </h3>
        <h4>Capture the Cosmos, Frame the Infinite!</h4>
        ...
        >
          <InfoBlock label="Duration" value="2 Days/1 Night" />
          <InfoBlock label="Difficulty" value="Easy" />
          <InfoBlock label="Age Group" value="6 to 50 Years" />
          <InfoBlock label="Altitude" value="750 ft" />
        </div>
  ...
  <div className="my-4">
    <ScheduleCard
      day="Day 1"
      title="Departure for Patdi"
      shortDesc="Astrophotography Sessions in Evening! "
      fullDesc="Departure from Ahmedabad at 2:30 PM in AC Seater bus, followed by arrival at our site near Patdi, Surendranagar. After reporting, we will have team games and ice-breaking sessions.

After dinner, spend an unforgettable evening under the stars with a series of exciting activities. Begin with the moon and star gazing through a large telescope, exploring the beauty of the night sky. Dive into engaging astronomy sessions to learn fascinating facts about celestial objects. Capture stunning photos during the astrophotography session, guided by experts.

Finally, witness the mesmerizing Lyrid meteor shower, a dazzling display that will make the night truly magical."
     // image={day1}
    />
      <ScheduleCard
      day="Day 2"
      title="Enjoy Desert Safari"
      shortDesc="Returning to Ahmedabad"
      fullDesc="In the morning, we will have breakfast. Afterward, we will spend some time at our resort and have the option to enjoy a desert safari (Fees for the desert safari are not included in the Package). At 11:00 AM, we will depart for Ahmedabad."
     // image={day1}
    />
